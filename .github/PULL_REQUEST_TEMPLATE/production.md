...
* [ ] Followed the guidelines for [building SDK modules](https://github.com/Hikari-Chain/hikari-chain/blob/main/docs/docs/building-modules)
* [ ] Included the necessary unit and integration [tests](https://github.com/Hikari-Chain/hikari-chain/blob/main/CONTRIBUTING.md#testing)
